...
the test data set. The training data are mostly comprised of nearby, low redshift, brighter samples while the test data contain higher redshift, fainter and more distant objects. It is entirely possible that there will be sources in test data, that do not have any counterparts in the training set.
